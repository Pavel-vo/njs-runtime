...
var NJS_INTERRUPT = {
    toString: function () {
        return "NJS_INTERRUPT"
    }
};

ext.NJS_TIMEOUT = NJS_TIMEOUT;
ext.NJS_INTERRUPT = NJS_INTERRUPT;

// use xNotifier = function() notation rather than function xNotifier()
// notation to sidestep a Safari closures bug.

var EventNotifier = function (retval) {
...
ext.EventNotifier = EventNotifier;

var ResultNotifier = function () {
...
ext.ResultNotifier = ResultNotifier;
...
ext.QueueNotifier = QueueNotifier;

QueueNotifier.prototype.size = function () {
    return this.results.length;
};

var isNotifier = function (n) {
    return n != null &&
...
ext.isNotifier = isNotifier;

var spawn = function (value) {
...
NjsRuntime.THROW = {
    toString: function () {
        return "NjsRuntime.THROW"
    }
};

var NJSUS = NjsRuntime.SUSPEND; // shortcut to reduce code bloat
ext.NJSUS = NJSUS;

// special identifer for constructors
NjsRuntime.NEW = {
    toString: function () {
        return "NjsRuntime.NEW"
    }
};
var NJNEW = NjsRuntime.NEW;
ext.NJNEW = NJNEW;
    ...
    nj:while (1) {
        switch (njf1.cp) {
            case 0:
                ...
                setTimeout(njf1._en, njf1._millis);
                njf1.pc(1,
                    njf1._en, "wait", []);
            case 1:
                with (njf1)if ((rv1 = f.apply(c, a)) == NJSUS) {
                    return fh;
                }
                break nj;
        }
...
var fetch = function (url, timeout) {
    var njf1 = njen(this, arguments, "url", "timeout");
    nj:while (1) {
        try {
            switch (njf1.cp) {
                case 0:
                    ...
                    njf1._http.onreadystatechange = njf1._en;
                    njf1.ecp = 1;

                    njf1._http.send(null);
                case 3:
                    njf1.cp = (njf1._http.readyState != 4) ? 4 : 5;
                    break;
                case 4:
                    njf1._startTime = new Date().getTime();
                    njf1.pc(6,
                        njf1._en, "wait", [njf1._timeout]);
                case 6:
                    with (njf1)if ((rv6 = f.apply(c, a)) == NJSUS) {
                        return fh;
                    }
                    njf1._timeout -= new Date().getTime() - njf1._startTime;
                    njf1.cp = 3;
                    break;
                case 5:
                    njf1.cp = 2;
                ...
                case 2:
                    ...
                    return njf1._http.responseText;
                    break nj;
            }
        } catch (ex) {
            njf1.doex(ex)
